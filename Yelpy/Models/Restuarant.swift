...
class Restaurant {
    ...
    init(dict:[String: Any]){
        ...
        activity = "Null"
        Restaurant.getActivity(id:id) {(returnString) in
            self.activity = returnString!
        }
    ...
    */
    ...
    static func getActivity(id: String, completion: @escaping (String?) -> Void) {
            ...
            if let error = error {
                ...
                parseObject.saveInBackground {
                  ...
                  if (success) {
                    ...
                    print(parseObject)
                    //returnString = "Current Activity Level: Normal"
                    completion("Current Activity Level: Normal")
                  } else {
                    // There was a problem, check error.description
                    print(error!.localizedDescription)
                    completion("Current Activity Level: Normal")
                ...
                let rating = object["currentRating"] as! Int
            
                if (rating < -10 ){
                    completion("Current Activity Level: Very Busy")
                }
                else if (rating > 10 ){
                    completion("Current Activity Level: Very Empty")
                }
                else {
                    completion("Current Activity Level: Normal")
                }
